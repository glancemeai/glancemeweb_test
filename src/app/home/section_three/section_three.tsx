...
const Section_three = () => {
    return (
       ...
       <Card heading="Decide at a Glance!" paragraph={`Quickly assess whether a video or article holds the insights you need. Preview contents of the video through timestamped topics list. GlanceMe delivers concise overviews so you can decide at a glance saving you precious time."`} tagLine="Quick Insights" image="/images/summary.png" altText="Quickly glance"/>
