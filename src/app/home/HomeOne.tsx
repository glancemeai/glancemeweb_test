  ...
  return (
    <div className={style.mainOne}>
      ...
      <div className={style.mainOneHolderOneItemOne}>
        ...
        <p id={style.mainOneHolderItemTextTwo}>learning <span>With</span></p>
      ...
      <div className={style.mainOneHolderOneItemTwo}>
        <div className={style.mainOneHolderOneItemTwoItemOne}>
          <p>Welcome</p>
          <span><FaAsterisk/></span>
        </div>
        <div className={style.mainOneHolderOneItemTwoItemTwo}>
          <p>Quickly glance the meetings, lectures, podcasts, depositions and more. Glanceme.Ai gives you superhuman recall and review using AI.</p>
        </div>
      </div>
      </div>
      ...
      <div className={style.mainOneHolderTwoItemTwo}>
        <div className={style.mainOneHolderTwoItemTwoOptions}>
          <p style={{background:"black",color:"white"}}>Personalized Lerning</p>
          <p>Online Lerning</p>
          <p>AI</p>
        </div>
        ...
        <div className={style.mainOneHolderTwoItemTwoTextHolder}>
          ...
          <h2>Flexible</h2>
          <hr color="black"/>
          <p>Our cutting-edge technology adapts to your needs and provides a tailored curriculum that help you succeed. Experience the future of education today.</p>
          </div>
          <div className={style.mainOneHolderTwoItemTwoIcon}>
            <p><FiArrowUpRight size={170}/></p>
          </div>
        </div>
      </div>
      </div>
